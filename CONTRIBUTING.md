Contributing to WIRE Core
============================

The WIRE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WIRE Core project, and is not to be
confused with overall WIRE Network Protocol consensus changes.

Whether a pull request is merged into WIRE Core rests with the project merge
...
Patches that change WIRE consensus rules are considerably more involved than
...
Where a patch set proposes to change the WIRE consensus, it must have been
...
The project leader is the release manager for each WIRE Core release.
