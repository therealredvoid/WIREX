...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WIRE features */
        {"wire", "masternode", &masternode, true, true, false},
        {"wire", "listmasternodes", &listmasternodes, true, true, false},
        {"wire", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wire", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wire", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wire", "masternodedebug", &masternodedebug, true, true, false},
        {"wire", "startmasternode", &startmasternode, true, true, false},
        {"wire", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wire", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wire", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wire", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wire", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wire", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wire", "mnbudget", &mnbudget, true, true, false},
        {"wire", "preparebudget", &preparebudget, true, true, false},
        {"wire", "submitbudget", &submitbudget, true, true, false},
        {"wire", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wire", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wire", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wire", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wire", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wire", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wire", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wire", "checkbudgets", &checkbudgets, true, true, false},
        {"wire", "mnsync", &mnsync, true, true, false},
        {"wire", "spork", &spork, true, true, false},
        {"wire", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"wire", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> wire-cli " + methodname + " " + args + "\n";
}
