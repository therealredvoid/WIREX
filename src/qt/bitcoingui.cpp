                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WIRE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WIRE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wire: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWIRE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WIRE Core"), this);
    aboutAction->setStatusTip(tr("Show information about WIRE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WIRE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WIRE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WIRE addresses"));
    ...
    openAction->setStatusTip(tr("Open a WIRE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WIRE Core help message to get a list with possible WIRE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WIRE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WIRE network", "", count));
}
...
{
    QString strTitle = tr("WIRE Core"); // default title
