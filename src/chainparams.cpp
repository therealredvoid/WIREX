...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1518561986; // October 17, 2017 4:30:00 AM
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "New York Times, 9/6/18 - Trump Prepares to Formalize Tariffs but Floats Exemptions.";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "wire-testnet.seed.fuzzbawls.pw"));
