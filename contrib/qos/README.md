...
This means one can have an always-on wired instance running, and another local wired/wire-qt instance which connects to this node and receives blocks from it.
